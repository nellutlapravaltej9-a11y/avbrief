        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-[#1E293B] border border-slate-700/50 rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-slate-300 leading-relaxed text-sm mb-4">
              AvBrief was built by <strong className="text-white font-medium">Nellutla Pravaltej</strong>, a student pilot and aspiring aerospace engineer, to make complex aviation weather reports accessible for pilots at every training level.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm mb-4">
              During flight planning, pilots are required to decode METAR observations and TAF forecasts to evaluate if weather conditions meet safe VFR or IFR thresholds. Standard code strings can be error-prone and tedious to translate manually in the cockpit. AvBrief instantly decodes raw codes into precise plain English variables, reducing cognitive load and enhancing situational awareness.
            </p>
